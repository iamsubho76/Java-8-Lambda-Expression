package com.org.v101_to_102.Java_8_DoubleAccumulator;
...
public class DoubleAccumulatorTest {
	...
	public static void main(String[] args) {
		...
		DoubleAccumulator doubleAccumulator = new DoubleAccumulator(
				accumulatorFunction, 5.0);

		DoubleAccumulatorServicerTask task1 = new DoubleAccumulatorServicerTask(
				doubleAccumulator, 10000L);
		DoubleAccumulatorServicerTask task2 = new DoubleAccumulatorServicerTask(
				doubleAccumulator, 10000L);
		...
		try {
			List<Future<Double>> invokeAll = Executors.newFixedThreadPool(2)
					.invokeAll(tasks);
