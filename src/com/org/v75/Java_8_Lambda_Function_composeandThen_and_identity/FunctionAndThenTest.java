package com.org.v75.Java_8_Lambda_Function_composeandThen_and_identity;
...
public class FunctionAndThenTest {
	public static void main(String args[]) {
		...
		List<Employee> employeeList = Arrays.asList(new Employee("Tom Jones",
				45), new Employee("Harry Major", 25), new Employee(
				"Ethan Hardy", 65), new Employee("Nancy Smith", 15),
		...
		List<String> empNameListInitialChar = convertEmpListToNamesList(
				employeeList, empNameFun.andThen(initialFunction));
