package com.org.v82.Java_8_Map_computeIfPresent_Default_Method;
...
public class MapComputeIfAbsentTest {
	...
	public static void main(String[] args) {
		...
		multiTechMap.computeIfAbsent("names", key -> new ArrayList<>()).add(
				"KK");
		...
		multiTechMap.computeIfAbsent("fruits", key -> new ArrayList<>()).add(
				"Apple");
		multiTechMap.computeIfAbsent("fruits", key -> new ArrayList<>()).add(
				"Mango");
		System.out.println("multimap: " + multiTechMap);
